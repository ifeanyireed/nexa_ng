      ...
      {isOpen && (
        <>
          ...
          <motion.div 
            ...
            className="fixed bottom-0 left-0 right-0 lg:top-1/2 lg:left-1/2 lg:-translate-x-1/2 lg:-translate-y-1/2 lg:bottom-auto w-full lg:max-w-xl bg-nexa-bg-base lg:rounded-[40px] shadow-2xl z-[110] overflow-hidden"
          >
            {/* HEADER */}
                  ...
                  {step === 2 && (
                     <motion.div key="step2" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-8">
                        <NexaCard variant="glass" className="p-6 border-nexa-brand/20 bg-nexa-brand/5">
                           <h4 className="text-xs font-bold text-nexa-text-faint uppercase tracking-widest mb-4">Booking Details</h4>
