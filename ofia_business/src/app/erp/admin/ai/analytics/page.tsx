...
export default function AnalyticsPage() {
  ...
  const [overview, setOverview] = useState({
    attributed_pipeline_usd: 320000000,
    pipeline_growth_pct: 38,
    blended_cac_usd: 84200,
    ...
    channel_performance: [
      { channel: "Email Cold Sequences", leads: 640, replies: 95, booked: 21, cac: "₦42,000", roi: "4.8x" },
      { channel: "WhatsApp Business API", leads: 320, replies: 68, booked: 18, cac: "₦28,000", roi: "6.2x" },
      { channel: "LinkedIn B2B Posts & Ads", leads: 180, replies: 24, booked: 6, cac: "₦110,000", roi: "2.4x" },
      { channel: "Meta & Instagram Retargeting", leads: 100, replies: 18, booked: 4, cac: "₦65,000", roi: "3.8x" },
    ],
  });
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <NexaCard variant="glass" padding="md" className="space-y-1.5">
                ...
                <div className="text-2xl font-black text-[var(--nexa-text-primary)] font-mono">
                  ₦{(overview.blended_cac_usd || 0).toLocaleString()}
                </div>
                <div className="text-xs text-[#0E9F6E] flex items-center gap-1 font-semibold">
