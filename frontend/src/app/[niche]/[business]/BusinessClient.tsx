    ...
    return (
      <main className="bg-nexa-bg-base min-h-screen flex items-center justify-center pt-32 pb-24">
        ...
        <div className="text-center space-y-6">
           ...
           <Link href={`/${data.id}`}>
              <NexaButton variant="secondary">Back to {data.name}</NexaButton>
           </Link>
        </div>
      </main>
    );
            ...
            <div className="flex flex-col lg:flex-row gap-12 items-start lg:items-end">
               ...
               <div className="flex-1 space-y-4">
                  <div className="flex flex-wrap items-center gap-3">
                     <NexaBadge variant="neutral" className="bg-nexa-bg-surface border-nexa-border uppercase tracking-widest text-[10px]">{pro.niche || data.name}</NexaBadge>
            ...
            <aside className="space-y-8">
               ...
               <NexaCard className="p-8 group overflow-hidden relative">
                  <div className="relative z-10 space-y-4">
                     ...
                     <Link href={`/${data.id}/${businessSlug}/shop`} className="block">
