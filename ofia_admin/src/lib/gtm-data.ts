...
export const INITIAL_AGENTS: AIAgent[] = [
  {
    ...
    todayStats: [
      ...
      { label: "Pipeline Value", value: "₦142.5M" },
  ...
  },
  {
    ...
    role: "Ads Strategist",
    category: "Strategy",
    avatar: "/character11.jpg",
    status: "online",
    currentTask: "Optimizing Meta & LinkedIn B2B audience retargeting and ROAS attribution",
    taskProgress: 100,
    todayStats: [
      { label: "ROAS", value: "3.8x" },
      { label: "Cost Per Lead", value: "₦18,400" },
      { label: "Retargeting Pool", value: "4.2k" },
    ],
    recommendation: "Increase daily ad spend by ₦150,000 on the top-performing school administrator lookalike audience.",
    confidence: 92,
    recentOutputs: [
  ...
  },
  {
    ...
    category: "Intelligence",
    avatar: "/character12.jpg",
    status: "working",
    currentTask: "Generating multi-touch conversion attribution models across all channels",
    taskProgress: 75,
    todayStats: [
      { label: "Attributed Pipeline", value: "₦320M" },
      { label: "Blended CAC", value: "₦84,200" },
...
export const INITIAL_APPROVALS: ApprovalItem[] = [
  ...
  {
    id: "appr-02",
    title: "Meta Retargeting Ad Budget Expansion (+₦150k/day)",
    type: "Ad Spend Increase",
    creatorAgent: "Kieran Patel",
    creatorAvatar: "/character11.jpg",
    riskLevel: "High",
    targetChannel: "Meta Ads (Instagram / Facebook)",
    scheduledTime: "Immediate upon approval",
    summary: "Increase daily ad spend from ₦100,000/day to ₦250,000/day on the top-performing 'School Administration Carousel' showing a 3.8x ROAS.",
    previewData: {
      budgetChange: "Current: ₦100,000/day → Proposed: ₦250,000/day (+₦150,000/day)",
