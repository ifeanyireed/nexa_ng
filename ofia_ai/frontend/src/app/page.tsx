...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--nexa-bg-base)] text-[var(--nexa-text-primary)] selection:bg-[#1A56DB] selection:text-white">
      ...
      <section className="relative pt-20 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto overflow-hidden">
        <div className="text-center space-y-6 max-w-4xl mx-auto">
          ...
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#1A56DB]/10 text-[#1A56DB] dark:bg-[#1A56DB]/20 border border-[#1A56DB]/30 text-xs font-extrabold shadow-sm">
            ...
            The Autonomous AI Workforce Era
          </div>
          ...
          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-black text-display tracking-tight text-[var(--nexa-text-primary)] leading-[1.08]">
            Replace 10 Disconnected Tools with a <span className="text-[#1A56DB]">14-Agent AI Revenue Team</span>
          </h1>

          {/* Subtitle */}
          <p className="text-sm sm:text-base lg:text-lg text-[var(--nexa-text-secondary)] max-w-3xl mx-auto leading-relaxed">
            Autonomous market research, verified lead extraction, high-converting copy, multi-channel dispatch across Email, WhatsApp, and LinkedIn, with instant Telegram mobile approvals — synchronized 24/7 with zero human fatigue.
          </p>
          ...
          <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link href="/signup">
              ...
              >
                Deploy Your AI Team — Free 14-Day Trial
              </NexaButton>
            </Link>
            <Link href="/dashboard">
              <NexaButton
          ...
          <div className="pt-6 flex flex-wrap items-center justify-center gap-6 text-xs text-[var(--nexa-text-muted)] font-medium">
            ...
            <span className="flex items-center gap-1.5">
              <CheckCircle2 className="w-4 h-4 text-[#0E9F6E]" /> Live AI Team in Under 10 Minutes
            </span>
          </div>
        </div>

        {/* Live AI Team Coordination Simulator Preview */}
            ...
            <div className="p-3.5 bg-[var(--nexa-bg-surface)] border-b border-[var(--nexa-border)] flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="ml-2 text-xs font-mono text-[var(--nexa-text-muted)]">
                  ai-orchestrator@cluster-01:~ [LIVE TELEMETRY]
                </span>
              </div>
              <div className="flex items-center gap-2">
      ...
      <section className="border-y border-[var(--nexa-border)] bg-[var(--nexa-bg-surface)]/50 py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          <div className="space-y-1">
            <div className="text-3xl sm:text-4xl font-black font-mono text-[#1A56DB]">₦142.5M</div>
      ...
      {/* The 4 Product Features & Capabilities */}
      <section id="features" className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        <div className="text-center space-y-3 max-w-3xl mx-auto">
          <NexaBadge variant="brand">Autonomous Capabilities</NexaBadge>
          <h2 className="text-3xl sm:text-5xl font-black text-display text-[var(--nexa-text-primary)]">
            Everything Your Revenue Team Needs. Fully Autonomous.
          </h2>
          <p className="text-xs sm:text-sm text-[var(--nexa-text-secondary)]">
            Four synchronized capabilities that replace an entire outbound stack and deliver predictable, recurring pipeline.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <NexaCard variant="glass" padding="lg" className="space-y-4 border-l-4 border-l-[#1A56DB]">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="text-xs text-[var(--nexa-text-muted)]">Email SES · WhatsApp WABA · LinkedIn B2B · Meta Ads</span>
              </div>
            </div>
            <p className="text-xs text-[var(--nexa-text-secondary)] leading-relaxed">
              Reach decision makers wherever they are active. Our AI specialists orchestrate synchronized multi-touch sequences across email inboxes, verified WhatsApp Cloud API, LinkedIn connection notes, and Meta lookalike ad audiences.
            </p>
          </NexaCard>
          ...
          <NexaCard variant="glass" padding="lg" className="space-y-4 border-l-4 border-l-[#0E9F6E]">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="text-xs text-[var(--nexa-text-muted)]">1-Tap Mobile Approvals & Real-Time Deal Alerts</span>
              </div>
            </div>
            <p className="text-xs text-[var(--nexa-text-secondary)] leading-relaxed">
              Stay in complete control without sitting in front of a laptop. Receive instant daily briefings, inspect generated copy, and approve campaigns with 1-click interactive inline buttons directly in Telegram.
            </p>
          </NexaCard>
          ...
          <NexaCard variant="glass" padding="lg" className="space-y-4 border-l-4 border-l-[#7E22CE]">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="text-xs text-[var(--nexa-text-muted)]">Zero Risk of Burned Domains or Ruined Reputation</span>
              </div>
            </div>
            <p className="text-xs text-[var(--nexa-text-secondary)] leading-relaxed">
              Algorithmic safety switches monitor campaign health in real time. If bounce rates exceed 3% or spam complaints spike, campaigns halt automatically and engage AWS SES inbox rotation to protect sender reputation.
            </p>
          </NexaCard>
          ...
          <NexaCard variant="glass" padding="lg" className="space-y-4 border-l-4 border-l-[#E3A008]">
            ...
            <p className="text-xs text-[var(--nexa-text-secondary)] leading-relaxed">
              Bring Your Own API Keys (BYOK) to pay raw token costs directly to LLM providers with 0% markup, or use our managed high-speed provider pools. Switch models anytime per agent task.
            </p>
          </NexaCard>
        </div>
      </section>

      {/* Live 14-Agent Team Explorer */}
      ...
      {/* Comparison: Ofia AI Swarm vs Traditional SDR Team */}
      <section className="py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        <div className="text-center space-y-2">
          <h2 className="text-3xl sm:text-4xl font-black text-display text-[var(--nexa-text-primary)]">
            Ofia AI Swarm vs Traditional 3-Person SDR Team
          </h2>
          <p className="text-xs sm:text-sm text-[var(--nexa-text-secondary)]">
            Why high-growth revenue leaders replace manual outbound chaos with autonomous 14-agent execution.
          </p>
        </div>
          ...
          <table className="w-full text-xs text-left border-collapse">
            <thead>
              <tr className="border-b border-[var(--nexa-border)] text-[var(--nexa-text-muted)] uppercase tracking-wider font-bold">
                ...
                <th className="py-3 px-4">3-Person Human SDR Team</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-[var(--nexa-border)] text-[var(--nexa-text-primary)] font-medium">
              <tr>
                ...
                <td className="py-4 px-4 font-black text-[#0E9F6E] bg-[#1A56DB]/5">₦450,000 - ₦2,400,000 / mo</td>
                <td className="py-4 px-4 text-red-500 font-mono">₦18,000,000+ / mo (Salaries + Tools)</td>
              </tr>
              <tr>
                <td className="py-4 px-4 font-bold">Outreach Channels</td>
                <td className="py-4 px-4 bg-[#1A56DB]/5 text-[#1A56DB] font-bold">
                  Email (SES), WhatsApp (WABA), LinkedIn, Meta Ads
                </td>
              ...
              <tr>
                ...
                <td className="py-4 px-4 text-[var(--nexa-text-secondary)]">3 - 6 Months Hiring & Ramp</td>
              </tr>
              <tr>
                <td className="py-4 px-4 font-bold">Operating Hours</td>
                <td className="py-4 px-4 bg-[#1A56DB]/5 font-bold text-[#0E9F6E]">24/7/365 Continuous Execution</td>
                <td className="py-4 px-4 text-[var(--nexa-text-secondary)]">8 Hours / Day (Fatigue & Turnover)</td>
              </tr>
              <tr>
      ...
      <section className="py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <NexaCard variant="glass" padding="lg" className="border-2 border-[#1A56DB] shadow-2xl text-center space-y-6 bg-gradient-to-b from-[#1A56DB]/10 to-transparent">
          ...
          <h2 className="text-3xl sm:text-5xl font-black text-display text-[var(--nexa-text-primary)]">
            Ready to Generate ₦100M+ in Pipeline This Month?
          </h2>

          <p className="text-xs sm:text-sm text-[var(--nexa-text-secondary)] max-w-xl mx-auto leading-relaxed">
            Connect your domain, meet your 14 autonomous agents, and launch your first high-converting multi-channel sequence in under 10 minutes.
          </p>
