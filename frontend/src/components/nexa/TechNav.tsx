...
export const TechNavbar = () => {
  return (
    <nav className="fixed top-0 left-0 right-0 z-40 h-16 liquid-glass border-b border-nexa-border px-4">
      <div className="container mx-auto h-full flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className="h-4 w-px bg-nexa-border mx-2 hidden sm:block" />
          <div className="hidden sm:flex items-center gap-2 px-3 py-1 bg-nexa-accent/10 rounded-full border border-nexa-accent/20">
            <span className="w-2 h-2 rounded-full bg-nexa-accent animate-pulse" />
            <span className="text-[10px] font-black text-nexa-accent uppercase tracking-widest">NX-881920</span>
          </div>
        </div>
            ...
            <Link key={i} href={tab.href} className="flex-1">
              <button
                className={cn(
                  ...
                  isActive ? "text-nexa-accent scale-110" : "text-nexa-text-faint hover:text-nexa-text-secondary"
                )}
              >
                <div className={cn(
                ...
                {isActive && (
                  <motion.div
                    ...
                    className="absolute bottom-2 w-1 h-1 rounded-full bg-nexa-accent"
