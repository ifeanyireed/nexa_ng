...
func InitDB() *gorm.DB {
	...
	if err != nil {
		log.Printf("⚠️ Warning: Failed to connect to MySQL database (%s): %v. Running in offline fallback readiness mode.", databaseURL, err)
		return nil
	}
	...
	log.Println("✅ AI GTM Service successfully connected to database u721451974_nexa_db")
	return DB
}
