    ...
    <footer className="pt-24 pb-12 bg-nexa-bg-base border-t-2 border-nexa-brand/10">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center gap-2 mb-6">
              <img src="/logo.png" alt="Ofia Compass Logo" className="w-8 h-8 object-contain" />
              <span className="text-xl font-bold text-display">Ofia Compass</span>
            </div>
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input type="email" placeholder="email@ofia.ng" className="flex-1 bg-nexa-bg-surface border border-nexa-border rounded-lg px-3 text-sm focus:outline-none focus:ring-2 focus:ring-nexa-brand-glow" />
        ...
        <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-nexa-border text-xs text-nexa-text-faint">
          <p>© 2026 Ofia Compass. All rights reserved.</p>
