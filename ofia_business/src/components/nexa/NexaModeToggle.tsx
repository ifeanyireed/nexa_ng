...
export type NexaMode = "buyer" | "seller";

interface NexaModeToggleProps {
  mode: NexaMode;
  onChange: (mode: NexaMode) => void;
  className?: string;
}

export const NexaModeToggle = ({ mode, onChange, className }: NexaModeToggleProps) => {
  return (
    <div
      className={cn(
    ...
    >
      ...
      <motion.div
        ...
        className={cn(
          ...
          mode === "buyer" ? "bg-nexa-brand" : "bg-nexa-accent"
        )}
        initial={false}
        animate={{
      ...
      <div
        ...
        className={cn(
          ...
          mode === "buyer" ? "text-white" : "text-nexa-text-faint hover:text-nexa-text-secondary"
        )}
      >
      ...
      <div
        ...
        className={cn(
          "relative z-10 flex-1 flex items-center justify-center gap-2 py-1.5 px-3 rounded-full transition-colors duration-200",
          mode === "seller" ? "text-white" : "text-nexa-text-faint hover:text-nexa-text-secondary"
        )}
      >
