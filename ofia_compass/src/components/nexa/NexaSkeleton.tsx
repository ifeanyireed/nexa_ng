...
export const NexaSkeleton = ({ variant = "text", className }: NexaSkeletonProps) => {
  const baseClasses = "skeleton-shimmer bg-nexa-bg-base/50 rounded-md relative overflow-hidden";
  ...
  if (variant === "list-item") {
    return (
      <div className={cn("flex items-center gap-4 py-3 border-b border-nexa-border", className)}>
