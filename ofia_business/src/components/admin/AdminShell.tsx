...
export const AdminShell = ({ children }: AdminShellProps) => {
  ...
  const navItems = [
    ...
    { label: "AI Agents & Health", href: "/admin/swarm", icon: Activity, badge: "15 Agents", alert: false },
          ...
          <header className="h-16 border-b border-[var(--nexa-border)] bg-[var(--nexa-bg-surface)]/80 backdrop-blur-xl flex items-center justify-between px-4 sm:px-6 z-20 shrink-0 sticky top-0">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                title="Emergency Agent Circuit Breaker"
              >
                <Power className="w-3.5 h-3.5" />
                <span>{isGlobalCircuitBreakerArmed ? "Circuit Breaker ARMED" : "Global Agent Killswitch"}</span>
              </button>
