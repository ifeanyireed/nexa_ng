    ...
    <BusinessShell
      ...
      action={
        <div className="flex items-center gap-2">
          <Link href="/erp/admin/referrals/campaigns">
            <NexaButton size="sm" variant="outline" leftIcon={<Gift className="w-3.5 h-3.5" />}>
              Reward Rules
            </NexaButton>
          </Link>
          <Link href="/erp/admin/referrals/payouts">
      ...
      <div className="space-y-8">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Link href="/erp/admin/referrals/affiliates" className="text-xs text-[#1A56DB] font-bold hover:underline flex items-center gap-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <Link href="/erp/admin/referrals/campaigns" className="block group">
          ...
          <Link href="/erp/admin/referrals/affiliates" className="block group">
          ...
          <Link href="/erp/admin/referrals/payouts" className="block group">
          ...
          <Link href="/erp/admin/referrals/analytics" className="block group">
