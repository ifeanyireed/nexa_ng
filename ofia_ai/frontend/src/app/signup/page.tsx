...
export default function SignupPage() {
  ...
  const handleCompleteSignup = () => {
    ...
    setTimeout(() => {
      setProvisioningStatus("Configuring 14 Autonomous AI Agents...");
    }, 800);
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-1 gap-2.5">
                    {[
                      ...
                      { id: "STARTER", name: "Starter Plan", price: "₦450,000/mo", desc: "1,000 Verified Leads · Email & WhatsApp" },
                      { id: "GROWTH", name: "Growth Plan (Recommended)", price: "₦1,200,000/mo", desc: "5,000 Verified Leads · Telegram CRO Bot · BYOK" },
                    ].map((plan) => (
                      <button
                        key={plan.id}
                        type="button"
