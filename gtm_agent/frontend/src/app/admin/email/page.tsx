          ...
          <div className="grid grid-cols-1 sm:grid-cols-5 gap-4">
            ...
            <div className="p-3.5 rounded-2xl bg-[var(--nexa-bg-base)] border border-[var(--nexa-border)] space-y-2">
              <div className="flex items-center justify-between">
                ...
                <NexaBadge variant="cyan">$450/mo</NexaBadge>
              </div>
              <NexaInput
                label="Max Emails / Day"
                placeholder="250"
            ...
            <div className="p-3.5 rounded-2xl bg-[var(--nexa-bg-base)] border border-[var(--nexa-border)] space-y-2">
              <div className="flex items-center justify-between">
                ...
                <NexaBadge variant="brand">$1,200/mo</NexaBadge>
              </div>
              <NexaInput
                label="Max Emails / Day"
                placeholder="1000"
            ...
            <div className="p-3.5 rounded-2xl bg-[var(--nexa-bg-base)] border border-[var(--nexa-border)] space-y-2">
              <div className="flex items-center justify-between">
                ...
                <NexaBadge variant="purple">$2,400/mo</NexaBadge>
              </div>
              <NexaInput
                label="Max Emails / Day"
                placeholder="4000"
            ...
            <div className="p-3.5 rounded-2xl bg-[var(--nexa-bg-base)] border border-[var(--nexa-border)] space-y-2">
              <div className="flex items-center justify-between">
                ...
                <NexaBadge variant="warning">$4,500/mo</NexaBadge>
              </div>
              <NexaInput
                label="Max Emails / Day"
                placeholder="10000"
