...
export default function SupportDisputePage() {
  ...
  const issues = [
    ...
    { id: "DISP-06", label: "Incorrect Parts", icon: <Tool className="w-6 h-6" /> },
  ];
            ...
            >
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                   ...
                   <p className="text-nexa-text-secondary font-medium mt-2">How can we help you with booking <span className="text-nexa-amber font-bold">{ref}</span>?</p>
                </div>
