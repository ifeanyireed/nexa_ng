    ...
    <section className="py-24 bg-nexa-bg-surface border-y border-nexa-border">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-extrabold text-display mb-4">How Ofia Compass Works</h2>
          <p className="text-nexa-text-secondary max-w-xl mx-auto">The simplest way to discover and connect with verified businesses across Nigeria.</p>
        </div>
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-nexa-brand/10 border border-nexa-brand/20 text-nexa-brand px-4 py-2 rounded-full mb-8 backdrop-blur-md mx-auto">
               ...
               <span className="text-[10px] font-bold uppercase tracking-[0.2em]">Ofia Compass for Business</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-extrabold mb-6 leading-tight tracking-tight">
              ...
              with <span className="text-nexa-brand">Ofia Compass Enterprise</span>.
            </h2>
                ...
                <div className="space-y-5 mb-10">
                  ...
                  <div className="flex items-start gap-4 group">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-white/85">Guaranteed service quality with Ofia Escrow payments and verified experts.</p>
                    </div>
                  </div>
                </div>
