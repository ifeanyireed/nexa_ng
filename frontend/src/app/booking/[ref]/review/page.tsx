...
export default function BookingReviewPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setError('');
        try {
            await api.post(`/bookings/${ref}/review`, {
                rating,
                comment,
            });
    ...
    return (
        <main className="bg-nexa-bg-base min-h-screen pb-24 lg:pb-12">
            ...
            <div className="container mx-auto px-4 pt-32">
                 <Link href={`/booking/${ref}/track`} className="text-xs font-bold text-nexa-brand uppercase tracking-widest flex items-center gap-2 mb-8">
